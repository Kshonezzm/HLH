files <- Sys.glob(file.path("/home/zmzhang/homo_HLH/GSE37202/stringtieflie","*","gene_abund.tab"))
...
write.table(expData,file="/home/zmzhang/homo_HLH/GSE37202/stringtieflie/gene_TPM.txt",sep='\t',quote=FALSE,row.names=T,col.names=T) 
