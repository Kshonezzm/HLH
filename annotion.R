...
scRNA2@meta.data$seurat_clusters <- scRNA2@meta.data$RNA_snn_res.0.1
Idents(scRNA2) <- scRNA2@meta.data$seurat_clusters
...
genes <- c("Slc17a7","Nrgn","Slc30a3","Slc17a6","Baiap3","Tcf4","Gad1","Gad2","Ctss","C1qb","C1qa","Slc1a3","Gja1","Aqp4","Acsbg1","Aspa","Ermn","Mog","Cacng4","Flt1","Cldn5")
#画dotplot图，注释利器之一
